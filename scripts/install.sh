...
APP_NAME="z-biz-tool-aigen"           # .app bundle 名称 (来自 tauri.conf.json productName)
BUNDLE_ID="com.zifang.z-biz-tool-aigen"  # bundle identifier
DISPLAY_NAME="z-biz-tool-aigen"
